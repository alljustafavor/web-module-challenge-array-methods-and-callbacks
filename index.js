...
function getYears(data, getYearsCB) {
    return getYearsCB(data).map(item => item.Year);
}
...
function getWinners(data, getFinalsCB) { //if home team goals are greater than awy return home          else return away
